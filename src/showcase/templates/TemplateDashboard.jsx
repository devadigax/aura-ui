...
export default function TemplateDashboard() {
  return (
    <TemplateLayout title="Dashboard" sourceCode={code}>
      <div>
        {/* ── Page Header ── */}
        <div className="glass mb-4" style={{ padding: '1.5rem 2rem', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <h2 className="fw-black mb-1" style={{ fontSize: '1.6rem', letterSpacing: '-0.5px' }}>Dashboard</h2>
            <p className="text-muted mb-0" style={{ fontSize: '0.85rem' }}>Friday, October 27, 2023 · Welcome back, Alex 👋</p>
          </div>
          <div className="d-flex gap-2">
            <Button variant="outline-primary" size="sm">
              <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '0.4rem', verticalAlign: 'middle' }}><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
              Oct 2023
            </Button>
            <Button variant="primary" size="sm">
              <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '0.4rem', verticalAlign: 'middle' }}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
              Export Report
            </Button>
          </div>
        </div>
