...
const features = [
  { icon: <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>, text: 'Enterprise-grade security with end-to-end encryption' },
  { icon: <><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></>, text: 'Collaborate with your team in real-time' },
  { icon: <><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></>, text: 'Beautiful dashboards and analytics built-in' },
];
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '3rem', minHeight: '80vh', alignItems: 'center' }}>
      ...
      <div className="d-none d-md-flex flex-column justify-content-center">
        <h1>Welcome Back to <span style={{ color: 'var(--accent)' }}>Aura UI</span></h1>
        {/* Features list... */}
      </div>
      {/* Right Form Panel */}
      <div className="d-flex align-items-center justify-content-center justify-content-md-end">
        <Card glass style={{ width: '100%', maxWidth: '420px' }}>
          {/* Login Form */}
        </Card>
      </div>
    </div>
...
export default function TemplateLogin() {
  ...
  return (
    <TemplateLayout title="Login" sourceCode={code} hideHeader>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '4rem', minHeight: '80vh', alignItems: 'center' }}>
        ...
        <div className="d-none d-md-flex flex-column justify-content-center" style={{ paddingRight: '2rem' }}>
          ...
          <p className="text-muted mb-5" style={{ fontSize: '1.05rem', lineHeight: 1.7, maxWidth: '420px' }}>
            Sign in to access your components, templates, and projects. Everything you left behind is right where you left it.
          </p>
          ...
          <div className="d-flex flex-column gap-4 mb-5">
            {features.map(({ icon, text }, i) => (
              <div key={i} className="d-flex align-items-center gap-3">
                ...
                <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: 1.4 }}>{text}</span>
              </div>
            ))}
          </div>

          {/* Testimonial Card */}
          <div className="glass p-4" style={{ borderRadius: 14, borderLeft: '3px solid var(--accent)' }}>
            <p className="mb-3" style={{ fontSize: '0.9rem', fontStyle: 'italic', lineHeight: 1.6 }}>
              "Aura UI cut our design-to-production time in half. The glass components look stunning in every context."
            </p>
            <div className="d-flex align-items-center gap-2">
              <img src="https://i.pravatar.cc/150?u=30" alt="Reviewer" style={{ width: 32, height: 32, borderRadius: '50%', border: '2px solid var(--accent)' }} />
              <div>
                <div className="fw-bold" style={{ fontSize: '0.82rem' }}>Sarah Jenkins</div>
                <div className="text-muted" style={{ fontSize: '0.72rem' }}>Lead Engineer, Vercel</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <form onSubmit={e => e.preventDefault()} style={{ marginTop: '1.25rem' }}>
                ...
                <FormGroup className="mb-3">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" style={{ color: 'var(--accent)', textDecoration: 'none', fontSize: '0.82rem', fontWeight: 500 }}>Forgot password?</a>
                  </div>
                  <div style={{ position: 'relative' }}>
                    <Input type={showPassword ? 'text' : 'password'} placeholder="••••••••" style={{ paddingRight: '2.75rem' }} />
                ...
                <Button variant="primary" className="w-100" size="lg" style={{ marginBottom: '1.25rem' }}>Sign In</Button>

                <p className="text-center mb-0" style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>
                  Don't have an account?{' '}
                  <a href="#" style={{ color: 'var(--accent)', fontWeight: 600, textDecoration: 'none' }}>Create one free →</a>
                </p>
              </form>
            </Card.Body>
          </Card>
